...
public class BimController {
	...
	//get user 
		@GetMapping("users")
		public List<Bim> getAllUser(){
			return this.bimRepository.findAll();
		}
		
		//get user by id
		@GetMapping("user/{id}")
		public ResponseEntity<Bim> getuserById(@PathVariable(value = "id") Long bimId)
		...
		public Bim createUser(@RequestBody Bim bim) {
			return this.bimRepository.save(bim);
		}
		
		//update user
		@PutMapping("update/{id}")
		public ResponseEntity<Bim> updateUser(@PathVariable(value = "id") Long bimId, @Validated @RequestBody Bim bimDetail) throws ResourceNotFoundException{
		...
		public Map<String, Boolean> deleteuser(@PathVariable(value = "id") Long bimId) throws ResourceNotFoundException {
